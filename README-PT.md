...
> **Por quê?** Pular a documentação e mandar o agente direto pro código parece mágico por 20 minutos. Depois a janela de contexto enche de comandos rasos e a qualidade desmorona. Este workflow coloca o pensamento na frente (PRD → sprints → specs) para que a implementação vire algo pequeno, auditável e quase entediante. O "entediante" é justamente o ponto.
